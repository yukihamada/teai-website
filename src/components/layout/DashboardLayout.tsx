...
const privateNavigation = [
  ...
  { name: 'インスタンス', href: '/instances' },
  { name: '使用状況', href: '/usage' },
];
                ...
                {user ? (
                  <div className="space-y-1">
                    ...
                    <Disclosure.Button
                      as="button"
                      onClick={handleLogout}
                      className="block w-full px-4 py-2 text-left text-base font-medium text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-800 dark:hover:text-white"
                    >
                      ログアウト
                    </Disclosure.Button>
                  </div>
